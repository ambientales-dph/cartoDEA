...
export const GeeTileLayerInputSchema = z.object({
  ...
  bandCombination: z.enum(['URBAN_FALSE_COLOR', 'SWIR_FALSE_COLOR', 'BSI', 'NDVI', 'JRC_WATER_OCCURRENCE', 'OPENLANDMAP_SOC', 'DYNAMIC_WORLD', 'NASADEM_ELEVATION', 'ALOS_DSM', 'COPERNICUS_DEM', 'TASSELED_CAP', 'GOES_CLOUDTOP', 'SMAP_SOIL_MOISTURE']).describe("The band combination or index to use for the layer."),
...
export const GeeProfileInputSchema = z.object({
  ...
  dataset: z.enum(['NASADEM_ELEVATION', 'ALOS_DSM', 'COPERNICUS_DEM', 'JRC_WATER_OCCURRENCE', 'SMAP_SOIL_MOISTURE']).describe('The elevation dataset to sample.'),
});
